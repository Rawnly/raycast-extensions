import { Action, ActionPanel, open, List, LaunchProps } from "@raycast/api";
...
function RecentlyPlayed(props: LaunchProps) {
          ...
          actions={
            <ActionPanel>
              ...
              <Action
                ...
                onAction={handleResult(() => Result.try(() => api.me.library.add("songs", item.id), Result.asError), {
